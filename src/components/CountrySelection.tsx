...
const CountrySelection: React.FC<CountrySelectionProps> = ({ category, onBack }) => {
  ...
  const CountryCard = ({ country }: { country: CountryWithUsers }) => (
    ...
    >
      {/* Glow effect */}
      <div className={`absolute inset-0 bg-gradient-to-r ${country.popular ? categoryInfo.gradient : 'from-emerald-500 to-blue-500'} rounded-2xl blur-lg opacity-0 group-hover:opacity-30 transition-opacity duration-300`}></div>

      {/* Main card */}
      <div className="relative bg-slate-800/50 backdrop-blur-md rounded-2xl border border-slate-700/50 hover:border-emerald-500/50 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl overflow-hidden">
        {/* Flag Section - Top Half */}
        <div className="h-32 bg-gradient-to-br from-slate-700/50 to-slate-600/50 flex items-center justify-center border-b border-slate-600/50 p-4">
        ...
        <div className="p-6">
          ...
          <div className={`flex items-center justify-center space-x-2 text-white bg-gradient-to-r ${country.popular ? categoryInfo.gradient : 'from-emerald-600 to-blue-600'} rounded-xl py-3 px-4 group-hover:shadow-lg transition-all duration-300`}>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <button
            onClick={onBack}
            className="group inline-flex items-center text-emerald-400 hover:text-white mb-8 transition-all duration-200 bg-slate-800/50 backdrop-blur-sm rounded-full px-6 py-3 hover:bg-slate-700/50"
          >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-slate-800/50 backdrop-blur-md rounded-3xl p-8 border border-slate-700/50">
            <div className="text-center">
              <div className="flex justify-center mb-6">
                <div className="bg-gradient-to-r from-emerald-500 to-blue-500 p-4 rounded-2xl">
              ...
              <button className="group inline-flex items-center px-8 py-4 border border-transparent text-lg font-medium rounded-xl text-white bg-gradient-to-r from-emerald-600 to-blue-600 hover:from-emerald-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
