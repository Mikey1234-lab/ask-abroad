  ...
  const categories = [
    {
      ...
      bgGradient: 'from-emerald-50 via-emerald-100 to-blue-100',
    ...
    },
    {
      ...
      bgGradient: 'from-blue-50 via-blue-100 to-emerald-100',
      borderGradient: 'from-blue-200 to-emerald-200',
    ...
    },
    {
      ...
      bgGradient: 'from-emerald-50 via-blue-100 to-emerald-100',
      borderGradient: 'from-emerald-200 to-blue-200',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-16">
          <div className="flex justify-center mb-6">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-emerald-400 to-blue-500 rounded-full blur-lg opacity-50 animate-pulse"></div>
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            Welcome <span className="bg-gradient-to-r from-emerald-400 to-blue-500 bg-clip-text text-transparent">{currentUser?.displayName}</span>!
          </h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto mb-16">
          {categories.map((category) => (
            ...
            >
              ...
              {/* Main card */}
              <div className={`relative bg-slate-800/50 backdrop-blur-md rounded-3xl p-8 border border-slate-700/50 hover:border-emerald-500/50 transition-all duration-500 transform hover:-translate-y-3 hover:shadow-2xl`}>
                {/* Header */}
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="bg-slate-700/50 rounded-xl p-4 text-center backdrop-blur-sm">
                  ...
                  <div className="bg-slate-700/50 rounded-xl p-4 text-center backdrop-blur-sm">
                    ...
                    <div className="text-slate-400 text-sm">Online Experts</div>
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-slate-800/50 backdrop-blur-md rounded-3xl p-8 border border-slate-700/50 text-center">
            <div className="flex justify-center mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div className="flex flex-col items-center space-y-2">
                ...
                <span className="text-slate-400 text-sm">Verified professionals</span>
              </div>
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <span className="text-slate-400 text-sm">Real experiences</span>
              </div>
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <span className="text-slate-400 text-sm">Always available</span>
              </div>
            </div>
          </div>
        </div>
